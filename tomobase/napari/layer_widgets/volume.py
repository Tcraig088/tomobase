...
class VolumeDataWidget(CollapsableWidget):
    def __init__(self, viewer: 'napari.viewer.Viewer', parent=None):
        ...
        self.label_type_entry = QLabel('Volume')
    ...
    def updateDims(self):
        ...
        if dims > self.viewer.dims.ndisplay:
            ...
            for key, value in label_dict.items():
                ...
                self.layout.addWidget(widget_label, 3+i, 0)
                self.layout.addWidget(widget_value, 3+i, 1)
