...
class LogHandler:
    """
    LogHandler class to manage logging configuration for tomobase.
    Provides custom log levels TRACE and VERBOSE, and methods to enable or disable CLI logging which are initialized when jupyter is enabled.
    """
    def __init__(self):
        name = "tomobase"
        level = logging.DEBUG
