...
from tomobase.core.registers import processes, categories



subcategory = categories.add_category('Tilt Corrections', value=5, inheritor = 'Align')
@processes.register(name='Tilt Shift', category=subcategory, subcategories=subcategory, use_numpy=True)
...
@processes.register(name='Tilt Rotation', category=subcategory, subcategories=subcategory, use_numpy=True)
