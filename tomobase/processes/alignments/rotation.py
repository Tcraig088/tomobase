...
@process_hook(name='Tilt Shift', category=subcategory, subcategories=subcategory, use_numpy=True)
...
@process_hook(name='Tilt Rotation', category=subcategory, subcategories=subcategory, use_numpy=True)
