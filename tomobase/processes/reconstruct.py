...
@tomobase_hook_process(name='Reconstruct Weighted SIRT', category=TOMOBASE_TRANSFORM_CATEGORIES.RECONSTRUCT)
...
@tomobase_hook_process(name='Reconstruct', category=TOMOBASE_TRANSFORM_CATEGORIES.RECONSTRUCT)
